...
namespace System.Management.Automation.Subsystem.Prediction
{
    ...
    public sealed class PredictiveSuggestion
    {
        ...
        {
            if (string.IsNullOrEmpty(suggestion)) throw new ArgumentNullException(nameof(suggestion));
    ...
    public static class CommandPrediction
    {
        ...
        [HiddenAttribute]
        public static Task<List<PredictionResult>> PredictInputAsync(PredictionClient client, Ast ast,
            Token[] astTokens)
        {
            return null;
        }
        ...
        [HiddenAttribute]
        public static Task<List<PredictionResult>> PredictInputAsync(PredictionClient client, Ast ast,
            Token[] astTokens, int millisecondsTimeout)
        {
            return null;
        }
        ...
        ///     When the value is <code>> 0</code>, it's the number of displayed suggestions from the list returned in
        ///     <see cref="session" />, starting from the index 0.
        ///     When the value is <code><= 0</code>, it means a single suggestion from the list got displayed, and the index is the
        ///     absolute value.
        /// </param>
        [HiddenAttribute]
        public static void OnSuggestionDisplayed(PredictionClient client, Guid predictorId, uint session,
            int countOrIndex)
        {
        }
        ...
        [HiddenAttribute]
        public static void OnSuggestionAccepted(PredictionClient client, Guid predictorId, uint session,

...
public abstract partial class ReadLine
{
    ...
    private static readonly NextLineToken NextLine = new();

    private static readonly KeyPlaceholder InputAcceptedNow = new();
    ...
    private static SelectionToken Selected(string s)
    {
    ...
    private static Action CheckThat(Action action)
    {

    ...
    public partial class ReadLine
    {
        ...
        public void ViChangeMovement()
        {
            ...
            Test("0123f", Keys(
                ...
                "lc", _.Spacebar, "c", _.Escape, CheckThat(() => AssertCursorLeftIs(2)),
                CheckThat(() => AssertLineIs("abcdcba")),
                "lc", _.Dollar, "def", _.Escape, CheckThat(() => AssertLineIs("abcdef")),
        ...
        public void ViChangeMovementUndo()
        {
            ...
            Test("", Keys(
                ...
                'c', _.Percent, "45678", _.Escape, CheckThat(() => AssertLineIs("0123456789ab")),
        ...
        public void ViDelete()
        {
            ...
            Test("", Keys(
                ...
                'd', _.Spacebar, CheckThat(() => AssertLineIs("012345678901234567")),
            ...
            Test("", Keys(
                "012 456 890", _.Escape, CheckThat(() => AssertLineIs("012 456 890")),
            ...
            Test("012 456 89a", Keys(
                "012 456 89a", _.Escape, CheckThat(() => AssertLineIs("012 456 89a")),
                CheckThat(() => AssertCursorLeftIs(10)),
            ...
            Test(" 12 456 89a", Keys(
                " 12 456 89a", _.Escape, CheckThat(() => AssertLineIs(" 12 456 89a")),
                CheckThat(() => AssertCursorLeftIs(10)),
        ...
        public void ViPercent()
        {
            ...
            Test("(1{3{5)789)b}c", Keys(
                "(1{3{5)789)b}c", _.Escape, CheckThat(() => AssertLineIs("(1{3{5)789)b}c")),
            ...
            Test("(1{3[5)7}9)b]d", Keys(
                "(1{3[5)7}9)b]d", _.Escape, CheckThat(() => AssertLineIs("(1{3[5)7}9)b]d")),
                CheckThat(() => AssertCursorLeftIs(13)),
                "h", _.Percent, "d", _.Percent, CheckThat(() => AssertLineIs("(1{3d")),
            ...
            Test("(1{3[5)7}9)b]c", Keys(
                "(1{3[5)7}9)b]c", _.Escape, CheckThat(() => AssertLineIs("(1{3[5)7}9)b]c")),
                CheckThat(() => AssertCursorLeftIs(13)),
                "hhhhh", _.Percent, "d", _.Percent, CheckThat(() => AssertLineIs("(19)b]c")),
                CheckThat(() => AssertCursorLeftIs(2)),
                "u", CheckThat(() => AssertLineIs("(1{3[5)7}9)b]c")), CheckThat(() => AssertCursorLeftIs(2))
            ));

            Test("012 [ 67 ] bc", Keys(
                "012 [ 67 ] bc", _.Escape, CheckThat(() => AssertLineIs("012 [ 67 ] bc")),
        ...
        public void ViMisc()
        {
            ...
            Test("abcdefg", Keys(
                ...
                '0', _.Tilde, _.Tilde, _.Tilde, _.Tilde, _.Tilde, _.Tilde, _.Tilde,
                CheckThat(() => AssertLineIs("ABCDEFG")),
                "uuuuuuu"
            ));
        ...
        public void ViChange()
        {
            ...
            Test("0[23]5", Keys(
                "0[23]5", _.Escape,
                "0wc", _.Percent, "abc", _.Escape, CheckThat(() => AssertLineIs("0abc5")),
                CheckThat(() => AssertCursorLeftIs(3)),
                "u0wc", _.Percent, "abc", _.Escape, CheckThat(() => AssertLineIs("0abc5")),
                CheckThat(() => AssertCursorLeftIs(3)),
                "u0w2c", _.Percent, "abc", _.Escape, CheckThat(() => AssertLineIs("0abc5")),
                CheckThat(() => AssertCursorLeftIs(3)),
                "u0w3c", _.Percent, "abc", _.Escape, CheckThat(() => AssertLineIs("0abc5")),
                CheckThat(() => AssertCursorLeftIs(3)),
                'u'
            ));
        ...
        {
            var adder = PSConsoleReadLineOptions.DefaultContinuationPrompt.Length;
            TestSetup(KeyMode.Vi);
            ...
            Test("\nline1", Keys(
                _.Escape, "oline1", CheckThat(() => AssertCursorLeftIs(5 + adder)),
                CheckThat(() => AssertLineIs("\nline1")),

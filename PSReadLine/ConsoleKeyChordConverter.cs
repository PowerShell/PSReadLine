...
public static class ConsoleKeyChordConverter
{
    ...
    {
        if (string.IsNullOrEmpty(chord)) throw new ArgumentNullException(nameof(chord));
    ...
    private static bool MapKeyChar(string input, ref ConsoleModifiers mods, out ConsoleKey key, out char keyChar)
    {

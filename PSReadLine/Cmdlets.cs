...
namespace PSConsoleUtilities
{
    ...
    public class SetKeyHandlerCommand : PSCmdlet
    {
        ...
        [ValidateSet("Abort", "AcceptLine", "AddLine", "BackwardChar", "BackwardDeleteChar",
                     "BackwardDeleteLine", "BackwardKillLine", "BackwardKillWord", "BackwardWord", "BeginningOfHistory",
                     "BeginningOfLine", "CancelLine", "ClearScreen", "Complete", "DeleteChar",
                     ...
                     "GotoBrace", "HistorySearchBackward", "HistorySearchForward", "KillLine", "KillWord",
                     "NextHistory", "NextWord", "Paste", "PossibleCompletions", "PreviousHistory",
                     "Redo", "ReverseSearchHistory", "RevertLine", "SelfInsert", "SetKeyHandler",
                     "SetMark", "ShellBackwardKillWord", "ShellBackwardWord", "ShellForwardWord", "ShellKillWord",
                     "TabCompleteNext", "TabCompletePrevious", "Undo", "UnixWordRubout", "Yank",

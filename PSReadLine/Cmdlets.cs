...
namespace PSConsoleUtilities
{
    ...
    public class SetKeyHandlerCommand : PSCmdlet
    {
        ...
        [ValidateSet("Abort", "AcceptLine", "AddLine", "BackwardChar", "BackwardDeleteChar",
                     "BackwardDeleteLine", "BackwardKillLine", "BeginningOfHistory", "BeginningOfLine", "CancelLine",
                     "ClearScreen", "Complete", "DeleteChar", "DisableDemoMode", "EnableDemoMode",
                     "EndOfHistory", "EndOfLine", "ExchangePointAndMark", "ForwardChar", "ForwardDeleteLine",
                     "ForwardSearchHistory", "GotoBrace", "HistorySearchBackward", "HistorySearchForward", "ShellBackwardKillWord",
                     "KillLine", "ShellKillWord", "NextHistory", "Paste", "PossibleCompletions",
                     "PreviousHistory", "Redo", "ReverseSearchHistory", "RevertLine", "SetKeyHandler",
                     "SetMark", "ShellBackwardWord", "ShellForwardWord", "TabCompleteNext", "TabCompletePrevious",
                     "Undo", "Yank", "YankPop")]

...
namespace PSConsoleUtilities
{
    public partial class PSConsoleReadLine
    {
        ...
        private static readonly Dictionary<ConsoleKeyInfo, KeyHandler> _viCmdKeyMap = new Dictionary<ConsoleKeyInfo, KeyHandler>(new ConsoleKeyInfoComparer())
            {
                ...
                { Keys.Y,               MakeViKeyHandler(Ding,                 "Ignore*") },
                ...
                { Keys.Percent,         MakeViKeyHandler(GotoBrace,            "GotoBrace*") },
        ...
        private static readonly Dictionary<ConsoleKeyInfo, KeyHandler> _viChordDTable = new Dictionary<ConsoleKeyInfo, KeyHandler>(new ConsoleKeyInfoComparer())
            {
                ...
                { Keys.ucB,             MakeViKeyHandler( BackwardDeleteWord,   "BackwardDeleteWord*") },
                { Keys.W,               MakeViKeyHandler( DeleteWord,           "DeleteWord*") },
                { Keys.ucW,             MakeViKeyHandler( DeleteWord,           "DeleteWord*") },
                { Keys.E,               MakeViKeyHandler( DeleteToEndOfWord,    "DeleteToEndOfWord*") },
                { Keys.ucE,             MakeViKeyHandler( DeleteToEndOfWord,    "DeleteToEndOfWord*") },
                ...
                { Keys.Percent,         MakeViKeyHandler( DeleteBrace,          "DeleteBrace*") }
            };
        private static readonly Dictionary<ConsoleKeyInfo, KeyHandler> _viChordCTable = new Dictionary<ConsoleKeyInfo, KeyHandler>(new ConsoleKeyInfoComparer())
            {
                ...
                { Keys.ucB,             MakeViKeyHandler( ViBackwardReplaceWord, "ViBackwardReplaceWord*") },
                { Keys.W,               MakeViKeyHandler( ViReplaceWord,         "ViReplaceWord*") },
                { Keys.ucW,             MakeViKeyHandler( ViReplaceWord,         "ViReplaceWord*") },
                { Keys.E,               MakeViKeyHandler( ViReplaceWord,         "ViReplaceWord*") },
                { Keys.ucE,             MakeViKeyHandler( ViReplaceWord,         "ViReplaceWord*") },
        ...
        private static readonly Dictionary<ConsoleKeyInfo, KeyHandler> _viChordYTable = new Dictionary<ConsoleKeyInfo, KeyHandler>(new ConsoleKeyInfoComparer())
            {
                { Keys.D,               MakeViKeyHandler( Ding,        "Ignore*") },
                { Keys.Dollar,          MakeViKeyHandler( Ding,        "Ignore*") },
                { Keys.B,               MakeViKeyHandler( Ding,        "Ignore*") },
                { Keys.ucB,             MakeViKeyHandler( Ding,        "Ignore*") },
                { Keys.W,               MakeViKeyHandler( Ding,        "Ignore*") },
                { Keys.ucW,             MakeViKeyHandler( Ding,        "Ignore*") },
                { Keys.E,               MakeViKeyHandler( Ding,        "Ignore*") },
                { Keys.ucE,             MakeViKeyHandler( Ding,        "Ignore*") },
                { Keys.H,               MakeViKeyHandler( Ding,        "Ignore*") },
                { Keys.L,               MakeViKeyHandler( Ding,        "Ignore*") },
                { Keys.Space,           MakeViKeyHandler( Ding,        "Ignore*") },
                { Keys._0,              MakeViKeyHandler( Ding,        "Ignore*") },
                { Keys.Uphat,           MakeViKeyHandler( Ding,        "Ignore*") },
                { Keys.Percent,         MakeViKeyHandler( Ding,        "Ignore*") }
            };

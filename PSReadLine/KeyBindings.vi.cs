        ...
        private static readonly Dictionary<ConsoleKeyInfo, KeyHandler> _viCmdKeyMap = new Dictionary<ConsoleKeyInfo, KeyHandler>(new ConsoleKeyInfoComparer())
            {
                ...
                { Keys.B,               MakeViKeyHandler(ViBackwardWord,       "ViBackwardWord", mode: "Cmd") },
                ...
                { Keys.P,               MakeViKeyHandler(PasteAfter,           "PasteAfter", mode: "Cmd") },
                ...
                { Keys.W,               MakeViKeyHandler(ViNextWord,           "ViNextWord", mode: "Cmd") },
                ...
                { Keys.ucB,             MakeViKeyHandler(ViBackwardGlob,       "ViBackwardGlob", mode: "Cmd") },
                ...
                { Keys.ucE,             MakeViKeyHandler(ViEndOfGlob,          "ViEndOfGlob", mode: "Cmd") },
                ...
                { Keys.ucP,             MakeViKeyHandler(PasteBefore,          "PasteBefore", mode: "Cmd") },
                ...
                { Keys.ucW,             MakeViKeyHandler(ViNextGlob,           "ViNextGlob", mode: "Cmd") },
